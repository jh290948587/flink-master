...
//        TODO 判断是否存在 Yarn Session 对应的AppID
        final boolean hasYarnAppId =
                commandLine.hasOption(applicationId.getOpt()) //TODO 看输入的命令有没有指定AppID
                        || configuration.getOptional(YarnConfigOptions.APPLICATION_ID).isPresent(); //TODO 看Yarn配置中有没有AppID

//        TODO 判断是否 -t 参数对应yarn-per-job或者yarn-session
...
//        TODO -m yarn-cluster || yarn有AppID，或者命令行指定了 || 执行期是yarn的
